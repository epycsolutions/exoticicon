...
describe('`TTF` font generator', () => {
    ...
    test('passes currectly format options to `svg2ttf` and sets `ts` (timestamp) to `0` by default to avoid generating unnessassary diffs', async () => {
