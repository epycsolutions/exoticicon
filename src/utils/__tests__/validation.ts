...
describe('CLI utilities', () => {
    describe('parseNumeric', () => {
        it.each([
            ...
            'returns correctly parse number - input: %s, output: %s',
            (input, output) => {
    ...
    describe('parseBoolean', () => {
        it.each([
            ...
            'correclty parses boolean-like values - input %s, output: %s',
            (input, output) => {
        ...
        it.each(['a', 2, -1, '2', {}, [], '', undefined, null])(
            ...
            input => {
                expect(() => parseBoolean(input)).toThrow(
    ...
    describe('parseDir', () => {
        it('calls `checkPath` correctly and return unchanged path if found to be an existing directory', async () => {
        ...
        it('throws expected error if given path is found not the be a directory', async () => {
            const dirname = '/foo/bar';
